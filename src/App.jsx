...
function App() {
    const profile = {
        ...
        links: {
            ...
            linkedin: "https://www.linkedin.com/in/kent-kawashima-42b823242/",
        },
    };

    const projects = [
        {
            name: "Predictive AI Text Generator",
            description:
        ...
        },
        {
            name: "Shared Sky",
            description:
                "Fullstack social media simulator emulating user interaction using generated data",
        ...
        },
        {
            name: "Blackjack",
            description:
                "Webhosted Blackjack utilizing vanilla frontend techonologies paired with object-oriented programming practices",
                    ...
                    <div className="container">
                        <div className="section-head">
                            ...
                            <p className="section-subtitle">
                                A few things I'm proud to have worked on in the
                                past.
                            </p>
                        </div>

                        <div className="grid-2">
                            {/* for each project, map contents to node display*/}
                            {projects.map((p) => (
                                <article
